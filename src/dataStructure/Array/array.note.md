...
3. Implementing queues via circular buffers.
4. Backing structure for hash tables (buckets), heaps (complete  binary tree via array indices), and matrices.
5. Buffers in networking and file I/O — contiguous memory is what hardware wants.
